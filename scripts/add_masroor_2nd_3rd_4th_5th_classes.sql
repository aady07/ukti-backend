-- =============================================================================
-- Masroor school: 2nd–5th Blue/Green — classes, teacher links, engagement cleanup,
...
-- Teachers (links only added; ON CONFLICT DO NOTHING — UKG/1st links unchanged):
--   nuzhatmasooudi325@gmail.com → 2nd/3rd/4th/5th Green
--   bhatreyaz1058@gmail.com     → 2nd/3rd/4th/5th Blue
--
-- Run: psql ... -v ON_ERROR_STOP=1 -f scripts/add_masroor_2nd_3rd_4th_5th_classes.sql
-- =============================================================================
...
-- Expected student counts: 5th Green 49, 5th Blue 49, 4th Green 41, 4th Blue 36,
-- 3rd Green 50, 3rd Blue 51, 2nd Green 47, 2nd Blue 47 (370 total; SNO 99 skipped).
